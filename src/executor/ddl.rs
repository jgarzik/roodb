...
// CreateView and DropView executors removed — views are now handled
// at the protocol level with Raft persistence (handle_create_view_raft/handle_drop_view_raft).
